...
for i in range(1, sample_size):
    ...
    #Get previous and current timestamp mrt flows
    for ii in range(station_cnt):
        timestamp_df_row[unique_station_names[ii] + "__mrt_flow"] = Y[i, ii]
    for ii in range(station_cnt):
...
df_new.to_csv("FinalData_Reshaped.csv", index=False)